...
В таблицы суммарно было вставлено порядка 5 миллионов строк, большинство которых пришлось на таблицу sessions. Генерация данных заняла где-то полторы минуты, все инсерты - полтора часа.
